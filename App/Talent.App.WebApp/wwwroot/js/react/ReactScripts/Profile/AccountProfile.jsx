...
import { TALENT_SERVICES_PROFILE } from '../HOSTNAME.js';
...
export default class AccountProfile extends React.Component {
    ...
    loadData() {
        ...
        $.ajax({
            url: `${TALENT_SERVICES_PROFILE}/profile/profile/getTalentProfile`,
            headers: {
    ...
    saveProfile() {
        var cookies = Cookies.get('talentAuthToken');
        $.ajax({
            url: `${TALENT_SERVICES_PROFILE}/profile/profile/updateTalentProfile`,
            headers: {
                'Authorization': 'Bearer ' + cookies,
                'Content-Type': 'application/json'
            },
                                    ...
                                    <div className="ui grid">
                                        ...
                                        >
                                            <PhotoUpload
                                                ...
                                                updateProfileData={this.updateWithoutSave}
                                                savePhotoUrl={`${TALENT_SERVICES_PROFILE}/profile/profile/updateProfilePhoto`}
                                            />
                                        </FormItemWrapper>
                                        <FormItemWrapper
                                            title='Profile Video'
                                        ...
                                        >
                                            <CVUpload
                                                ...
                                                updateProfileData={this.updateWithoutSave}
                                                saveCVUrl={`${TALENT_SERVICES_PROFILE}/profile/profile/updateTalentCV`}
                                            />
                                        </FormItemWrapper>
                                        <SelfIntroduction
